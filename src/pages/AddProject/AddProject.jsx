import { getInstructors } from "@/api/instructors"; // Ensure this API exists
...
// Define the schema for a project with a max length for name
...
export function AddProject() {
  // Fetch internships and instructors data
  const {
  ...
  // Use useFieldArray to manage dynamic team member fields
